...
public class MainActivity extends Activity implements MediaCaptureCallback, NetworkCallback
{
    private static final String TAG = "YueTing";
    ...
    private TextView captureStatusDecoder = null;
    private TextView captureStatusResolution = null;
    ...
    private ImageView interactiveArea = null;

    public TextView typingTextView = null;
    private TextView can1 = null;
    private TextView can2 = null;
    private TextView can3 = null;
    private TextView can4 = null;
    private TextView can5 = null;

    private int resolution_X = 1920;
    private int resolution_Y = 1080;
...
//        mWakeLock = pm.newWakeLock(PowerManager.FULL_WAKE_LOCK, "veg.mediacapture.sdk.test.mediastream");
        ...
        CommandNetwork.getInstance().start(this);
        CommandNetwork.getInstance().setCallback(this);

        interactiveArea = findViewById(R.id.interactive);
        GestureHandler gestureHandler = new GestureHandler();
        interactiveArea.setOnTouchListener(gestureHandler);

        captureStatusText = (TextView)findViewById(R.id.statusRec);
        captureStatusDecoder = (TextView)findViewById(R.id.statusdecoder);
        captureStatusResolution = (TextView)findViewById(R.id.statusResolution);
        captureStatusStat = (TextView)findViewById(R.id.statusStat);
        captureStatusStat.setText("");
        typingTextView = findViewById(R.id.text_typed);
        can1 = findViewById(R.id.can1);
        can2 = findViewById(R.id.can2);
        can3 = findViewById(R.id.can3);
        can4 = findViewById(R.id.can4);
        can5 = findViewById(R.id.can5);
        ...
        mbuttonRec.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Log.d("YueTing","Rec Button onClicked!");
                        ...
                        if( !isRec() ){
                            ...
                            captureStatusResolution.setText("Resolution: " + String.valueOf(resolution_X) + "x" + String.valueOf(resolution_Y));
                            captureStatusDecoder.setText("Encoder: H.264");
//                            captureStatusStat.setText("");
...
*/
		...
		*/
        ...
        Log.d("YueTingg",String.valueOf(resX));
...
//        if (mWakeLock.isHeld()) mWakeLock.release();
    ...
    public void updateTypingStatus(final String res) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                typingTextView.setText(res);
            }
        });
    }

    @Override
    public void onReceiveData(final JSONObject json) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                try {
                    String result = json.getString("typing");
                    typingTextView.setText(result);
                    String highlighted = json.getString("highlight");
                    switch(highlighted) {
                        case "1":
                    ...
                    JSONObject candidateList = json.getJSONObject("candidate_list");
                    can1.setText(candidateList.getString("1"));
                    can2.setText(candidateList.getString("2"));
                    can3.setText(candidateList.getString("3"));
                    can4.setText(candidateList.getString("4"));
                    can5.setText(candidateList.getString("5"));
